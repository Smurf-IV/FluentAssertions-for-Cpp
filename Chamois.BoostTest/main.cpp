...
{
	Chamois::Assert::That(10).Should().BeLessThan(20, "10 should be less than twenty");
}
...
{
	Chamois::Assert::That(10).Should().BeInRange(5, 20, "10 should bebetween 5 and 20");
}

BOOST_AUTO_TEST_CASE(Chamois_Assert_10_NotBeInRange_int_5_9)
{
	Chamois::Assert::That(10).Should().NotBeInRange(5, 9, "10 should be not between 5 and 9");
}
...
BOOST_AUTO_TEST_CASE(Chamois_Assert_Equal_Array)
{
	int A[5] = { 1, 2, 3, 4, 5 };
	int B[5] = { 1, 2, 3, 4, 5 };
	Chamois::Assert::ThatArray(A).Should().Be(B, "arrays should be equal");
}

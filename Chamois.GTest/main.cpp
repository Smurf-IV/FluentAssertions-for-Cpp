...
{		
	Assert::That(10).Should().Be(10, L"10 is equal to 10");
}

TEST(ChamoisTest, Chamois_Assert_NotEqual_int_10)
{
	Assert::That(10).Should().NotBe(5, L"10 is not equal to five");
}

TEST(ChamoisTest, Chamois_Assert_BeGreaterThan_int_10)
{
	Assert::That(10).Should().BeGreaterThan(5, L"10 is greater than five");
}

TEST(ChamoisTest, Chamois_Assert_BeGreaterThan_int_10_5)
{
	Assert::That(10).Should().BeGreaterThanOrEqual(5, L"10 is greater than or equal to five");
}

TEST(ChamoisTest, Chamois_Assert_BeGreaterThanOrEqual_int_10)
{
	Assert::That(10).Should().BeGreaterThanOrEqual(10, L"10 is greater or equal to 10");
}

TEST(ChamoisTest, Chamois_Assert_BeLessThan_int_10_20)
{
	Assert::That(10).Should().BeLessThan(20, L"10 is greater than twenty");
}

TEST(ChamoisTest, Chamois_Assert_BeLessThanOrEqual_int_10_10)
{
	Assert::That(10).Should().BeLessThanOrEqual(10, L"10 is less than or equal 10");
}

TEST(ChamoisTest, Chamois_Assert_BeLessThanOrEqual_int_10_20)
{
	Assert::That(10).Should().BeLessThanOrEqual(20, L"10 is less than or equal twenty");
}

TEST(ChamoisTest, Chamois_Assert_10_BeInRange_int_5_20)
{
	Assert::That(10).Should().BeInRange(5, 20, L"10 between 5 and 20");
}

TEST(ChamoisTest, Chamois_Assert_10_NotBeInRange_int_5_9)
{
	Assert::That(10).Should().NotBeInRange(5, 9, L"10 is not between 5 and 9");
}


TEST(ChamoisTest, Chamois_Assert_Equal_char_10)
{
	Assert::That((char)10).Should().Be((char)10, L"10 is equal to 10");
}

TEST(ChamoisTest, Chamois_Assert_NotEqual_char_10)
{
	Assert::That((char)10).Should().NotBe((char)5, L"10 is not equal to five");
}
...
{
	Assert::That(2.4f).Should().Be(2.4f, L"2.4 is equal to 2.4");
}

TEST(ChamoisTest, Chamois_Assert_NotEqual_float_2_4)
{
	Assert::That(2.4f).Should().NotBe(2.5f, L"2.4 is not equal to 2.5");
}

TEST(ChamoisTest, Chamois_Assert_True_bool)
{
	Assert::That(true).Should().BeTrue(L"true is true");
}

TEST(ChamoisTest, Chamois_Assert_False_bool)
{
	Assert::That(false).Should().BeFalse(L"false is false");
}
...
TEST(ChamoisTest, Chamois_Assert_Equal_Strings)
{
	...
	Assert::That(A).Should().Be(B, L"strings equal");
}

TEST(ChamoisTest, Chamois_Assert_Equal_Strings_Inline)
{
	Assert::That(L"hello").Should().Be(L"hello", L"strings equal");
}

TEST(ChamoisTest, Chamois_Assert_Equal_Strings_Inline_char)
{
	Assert::That("hello").Should().Be("hello", L"strings equal");
}

TEST(ChamoisTest, Chamois_Assert_NotEqual_Strings_Inline)
{
	Assert::That(L"hello").Should().NotBe(L"goodbye", L"strings not equal");
}

TEST(ChamoisTest, Chamois_Assert_NotEqual_Strings_Inline_char)
{
	Assert::That("hello").Should().NotBe("goodbye", L"strings not equal");
}

TEST(ChamoisTest, Chamois_Assert_String_StartsWith)
{
	Assert::That(L"hello").Should().StartWith(L"hel", L"string starts with hel");
}
...
TEST(ChamoisTest, Chamois_Assert_NotEqual_Strings)
{
	...
	Assert::That(A).Should().NotBe(B, L"strings not equal");
}
...
TEST(ChamoisTest, Chamois_Assert_Equal_Array)
{
	int A[5] = { 1, 2, 3, 4, 5 };
	int B[5] = { 1, 2, 3, 4, 5 };
	Assert::ThatArray(A).Should().Be(B, L"arrays are equal");
}
...
TEST(ChamoisTest, Chamois_Assert_NotEqual_Length_Array)
{
	int A[5] = { 1, 2, 3, 4, 5 };
	int B[6] = { 1, 2, 3, 4, 5, 6 };
	Assert::ThatArray(A).Should().NotBe(B, L"arrays are not equal");
}
...
TEST(ChamoisTest, Chamois_Assert_Container_Vector_Equal)
{
	...
	Assert::ThatContainer(A).Should().Be(B, L"vectors are equal.");
}
...
TEST(ChamoisTest, Chamois_Assert_Container_Vector_NotEqual)
{
	...
	Assert::ThatContainer(A).Should().NotBe(B, L"vectors are not equal.");
}
...
TEST(ChamoisTest, Chamois_Assert_Container_Vector_Empty)
{
	...
	Assert::ThatContainer(A).Should().BeEmpty(L"vectors empty.");
}
...
TEST(ChamoisTest, Chamois_Assert_Container_Vector_NotEmpty)
{
	...
	Assert::ThatContainer(A).Should().NotBeEmpty(L"vectors not empty.");
}
...
TEST(ChamoisTest, Chamois_Assert_Container_Map_Equal)
{
	...
	Assert::ThatContainer(A).Should().Be(B, L"map are equal.");
}
...
TEST(ChamoisTest, Chamois_Assert_Container_Map_NotEqual)
{
	...
	Assert::ThatContainer(A).Should().NotBe(B, L"map are not equal.");
}
...
TEST(ChamoisTest, Chamois_Assert_Container_Map_Empty)
{
	...
	Assert::ThatContainer(A).Should().BeEmpty(L"map empty.");
}
...
TEST(ChamoisTest, Chamois_Assert_Container_Map_NotEmpty)
{
	...
	Assert::ThatContainer(A).Should().NotBeEmpty(L"map not empty.");
}
...
TEST(ChamoisTest, Chamois_Assert_NotEqual_Array_Differs_DemonstratingFailure)
{
	int A[5] = { 1, 2, 3, 4, 5 };
	int B[5] = { 1, 2, 4, 4, 5 };
	Assert::ThatArray(A).Should().Be(B, L"arrays are not equal");
}
#endif

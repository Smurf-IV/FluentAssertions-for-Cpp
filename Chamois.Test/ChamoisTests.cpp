...
namespace ChamoisTest
{
    ...
    public:
        ...
        {
            Assert::That(10).Should().BeLessThan(20, "10 should be  less than 20");
        }
        ...
        {
            Assert::That(10).Should().BeInRange(5, 20, "10 should be between 5 and 20");
        }

        TEST_METHOD(Chamois_Assert_10_NotBeInRange_int_5_9)
        {
            Assert::That(10).Should().NotBeInRange(5, 9, "10 should not be between 5 and 9");
        }
        ...
        TEST_METHOD(Chamois_Assert_Equal_Array)
        {
            int A[5] = { 1, 2, 3, 4, 5 };
            int B[5] = { 1, 2, 3, 4, 5 };
            Assert::ThatArray(A).Should().Be(B, "arrays should be are equal");
        }

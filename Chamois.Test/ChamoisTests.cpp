...
{		
	...
	public:
		...
		{		
			Chamois::Assert::That(10).Should().Be(10, "10 should be  equal to 10");
		}

		TEST_METHOD(Chamois_Assert_NotEqual_int_10)
		{		
			Chamois::Assert::That(10).Should().NotBe(5, "10 should be  not equal to five");
		}

		TEST_METHOD(Chamois_Assert_BeGreaterThan_int_10)
		{		
			Chamois::Assert::That(10).Should().BeGreaterThan(5, "10 should be  greater than five");
		}
		
		TEST_METHOD(Chamois_Assert_BeGreaterThan_int_10_5)
		{		
			Chamois::Assert::That(10).Should().BeGreaterThanOrEqual(5, "10 should be  greater than or equal to five");
		}

		TEST_METHOD(Chamois_Assert_BeGreaterThanOrEqual_int_10)
		{		
			Chamois::Assert::That(10).Should().BeGreaterThanOrEqual(10, "10 should be  greater or equal to 10");
		}
		
		TEST_METHOD(Chamois_Assert_BeLessThan_int_10_20)
		{		
			Chamois::Assert::That(10).Should().BeLessThan(20, "10 should be  less than 20");
		}

		TEST_METHOD(Chamois_Assert_BeLessThanOrEqual_int_10_10)
		{		
			Chamois::Assert::That(10).Should().BeLessThanOrEqual(10, "10 should be  less than or equal 10");
		}

		TEST_METHOD(Chamois_Assert_BeLessThanOrEqual_int_10_20)
		{		
			Chamois::Assert::That(10).Should().BeLessThanOrEqual(20, "10 should be  less than or equal twenty");
		}

		TEST_METHOD(Chamois_Assert_10_BeInRange_int_5_20)
		{		
			Chamois::Assert::That(10).Should().BeInRange(5, 20, "10 should be between 5 and 20");
		}

		TEST_METHOD(Chamois_Assert_10_NotBeInRange_int_5_9)
		{		
			Chamois::Assert::That(10).Should().NotBeInRange(5, 9, "10 should not be between 5 and 9");
		}


		TEST_METHOD(Chamois_Assert_Equal_char_10)
		{
			Chamois::Assert::That((char)10).Should().Be((char)10, "10 should be  equal to 10");
		}

		TEST_METHOD(Chamois_Assert_NotEqual_char_10)
		{
			Chamois::Assert::That((char)10).Should().NotBe((char)5, "10 should be  not equal to five");
		}
		...
		{		
			Chamois::Assert::That(2.4f).Should().Be(2.4f, "2.4 should be  equal to 2.4");
		}

		TEST_METHOD(Chamois_Assert_NotEqual_float_2_4)
		{		
			Chamois::Assert::That(2.4f).Should().NotBe(2.5f, "2.4 should be  not equal to 2.5");
		}

		TEST_METHOD(Chamois_Assert_True_bool)
		{		
			Chamois::Assert::That(true).Should().BeTrue( "true should be  true");
		}

		TEST_METHOD(Chamois_Assert_False_bool)
		{		
			Chamois::Assert::That(false).Should().BeFalse( "false should be  false");
		}
		...
		{		
			Chamois::Assert::That("hello").Should().NotBe("goodbye", "strings should be not equal");
		}

		TEST_METHOD(Chamois_Assert_String_StartsWith)
		{		
			Chamois::Assert::That( "hello").Should().StartWith( "hel", "string should be starts with hel");
		}
		...
		{		
			...
			Chamois::Assert::That(A).Should().Be(B, "strings should be equal");
		}
		...
		{		
			int A[5] = { 1, 2, 3, 4, 5 };
			int B[5] = { 1, 2, 3, 4, 5 };
			Chamois::Assert::ThatArray(A).Should().Be(B, "arrays should be are equal");
		}
		...
		*/
		TEST_METHOD(Chamois_Assert_Container_Vector_Equal)
		{
			...
			Chamois::Assert::ThatContainer(A).Should().Be(B, "vectors should be  equal.");
		}
		...
		TEST_METHOD(Chamois_Assert_Container_Vector_NotEqual)
		{
			...
			Chamois::Assert::ThatContainer(A).Should().NotBe(B, "vectors should be  not equal.");
		}
		...
		TEST_METHOD(Chamois_Assert_Container_Vector_Empty)
		{
			...
			Chamois::Assert::ThatContainer(A).Should().BeEmpty( "vectors should be empty.");
		}
		...
		TEST_METHOD(Chamois_Assert_Container_Vector_NotEmpty)
		{
			...
			Chamois::Assert::ThatContainer(A).Should().NotBeEmpty( "vectors should be not empty.");
		}
		...
		TEST_METHOD(Chamois_Assert_Container_Map_Equal)
		{
			...
			Chamois::Assert::ThatContainer(A).Should().Be(B, "map should be  equal.");
		}
		...
		TEST_METHOD(Chamois_Assert_Container_Map_NotEqual)
		{
			...
			Chamois::Assert::ThatContainer(A).Should().NotBe(B, "map should be  not equal.");
		}
		...
		TEST_METHOD(Chamois_Assert_Container_Map_Empty)
		{
			...
			Chamois::Assert::ThatContainer(A).Should().BeEmpty( "map should be empty.");
		}
		...
		TEST_METHOD(Chamois_Assert_Container_Map_NotEmpty)
		{
			...
			Chamois::Assert::ThatContainer(A).Should().NotBeEmpty( "map should be not empty.");
		}
		/* 
...
//#ifdef CHAMOIS_TEST_ENABLE_FAILING_TESTS
		...
		TEST_METHOD(Chamois_Assert_NotEqual_Array_Differs_DemonstratingFailure)
		{
			int A[5] = { 1, 2, 3, 4, 5 };
			int B[5] = { 1, 2, 4, 4, 5 };
			Chamois::Assert::ThatArray(A).Should().Be(B, "arrays should be  not equal");
		}
//#endif
